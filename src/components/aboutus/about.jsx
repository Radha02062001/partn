...
const Heads = () => {
  const pictureo = new URL("../../assets/Images/p1.jpg", import.meta.url);
  const picturet = new URL("../../assets/Images/p2.webp", import.meta.url);
  const picturef = new URL("../../assets/Images/p3.webp", import.meta.url);
